...
Class SQLiteDB Extends SQLiteDB.BaseClass {
   ...
   Class BaseClass {
      Static Version := ""
      Static _SQLiteDLL := A_PtrSize == 8 ? A_ScriptDir . "\lib\SQLite3_64.dll" : A_ScriptDir . "\lib\SQLite3.dll"
      Static _SQLiteDLLRel := A_PtrSize == 8 ? "SQLite3_64.dll" : "SQLite3.dll"
      Static _RefCount := 0
   ...
   Class _RecordSet {
      ...
      Next(ByRef Row) {
         ...
         RC := DllCall(this._SQLiteDLLRel "\sqlite3_step", "Ptr", This._Handle, "Cdecl Int")
         If (ErrorLevel) {
         ...
         RC := DllCall(this._SQLiteDLLRel "\sqlite3_data_count", "Ptr", This._Handle, "Cdecl Int")
         If (ErrorLevel) {
         ...
         Loop, %RC% {
            Column := A_Index - 1
            ColumnType := DllCall(this._SQLiteDLLRel "\sqlite3_column_type", "Ptr", This._Handle, "Int", Column, "Cdecl Int")
            If (ErrorLevel) {
            ...
            If (ColumnType = SQLITE_NULL) {
               ...
               BlobPtr := DllCall(this._SQLiteDLLRel "\sqlite3_column_blob", "Ptr", This._Handle, "Int", Column, "Cdecl UPtr")
               BlobSize := DllCall(this._SQLiteDLLRel "\sqlite3_column_bytes", "Ptr", This._Handle, "Int", Column, "Cdecl Int")
               ...
               StrPtr := DllCall(this._SQLiteDLLRel "\sqlite3_column_text", "Ptr", This._Handle, "Int", Column, "Cdecl UPtr")
               If (ErrorLevel) {
      ...
      Reset() {
         ...
         RC := DllCall(this._SQLiteDLLRel "\sqlite3_reset", "Ptr", This._Handle, "Cdecl Int")
         If (ErrorLevel) {
      ...
      Free() {
         ...
         If !(This._Handle)
            Return True
         RC := DllCall(this._SQLiteDLLRel "\sqlite3_finalize", "Ptr", This._Handle, "Cdecl Int")
         If (ErrorLevel) {
   ...
   __New() {
      ...
      If (This.Base._RefCount = 0) {
         ...
         This.Base.Version := StrGet(DllCall(this._SQLiteDLLRel "\sqlite3_libversion", "Cdecl UPtr"), "UTF-8")
   ...
   ; ===================================================================================================================
   _ErrMsg() {
      If (RC := DllCall(this._SQLiteDLLRel "\sqlite3_errmsg", "Ptr", This._Handle, "Cdecl UPtr"))
   ...
   ; ===================================================================================================================
   _ErrCode() {
      Return DllCall(this._SQLiteDLLRel "\sqlite3_errcode", "Ptr", This._Handle, "Cdecl Int")
   }
   ; ===================================================================================================================
   ; PRIVATE _Changes
   ; ===================================================================================================================
   _Changes() {
      Return DllCall(this._SQLiteDLLRel "\sqlite3_changes", "Ptr", This._Handle, "Cdecl Int")
   }
   ; ===================================================================================================================
   ; PRIVATE _Returncode
   ; ===================================================================================================================
   ...
   OpenDB(DBPath, Access := "W", Create := True) {
      ...
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_open_v2", "Ptr", &UTF8, "PtrP", HDB, "Int", Flags, "Ptr", 0, "Cdecl Int")
      If (ErrorLevel) {
         This._Path := ""
   ...
   CloseDB() {
      ...
      For Each, Query in This._Queries
         DllCall(this._SQLiteDLLRel "\sqlite3_finalize", "Ptr", Query, "Cdecl Int")
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_close", "Ptr", This._Handle, "Cdecl Int")
      If (ErrorLevel) {
   ...
   Exec(SQL, Callback := "") {
      ...
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_exec", "Ptr", This._Handle, "Ptr", &UTF8, "Int", CBPtr, "Ptr", Object(This)
                  , "PtrP", Err, "Cdecl Int")
      ...
      If (RC) {
         ...
         This.ErrorCode := RC
         DllCall(this._SQLiteDLLRel "\sqlite3_free", "Ptr", Err, "Cdecl")
         Return False
      }
   ...
   GetTable(SQL, ByRef TB, MaxResult := 0) {
      ...
      If (MaxResult < -2)
         MaxResult := 0
      This._StrToUTF8(SQL, UTF8)
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_get_table", "Ptr", This._Handle, "Ptr", &UTF8, "PtrP", Table
      ...
      TB.RowCount := Rows
      If (MaxResult = -1) {
         DllCall(this._SQLiteDLLRel "\sqlite3_free_table", "Ptr", Table, "Cdecl")
         If (ErrorLevel) {
   ...
   Query(SQL, ByRef RS) {
      ...
      Query := 0
      This._StrToUTF8(SQL, UTF8)
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_prepare_v2", "Ptr", This._Handle, "Ptr", &UTF8, "Int", -1
      ...
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_column_count", "Ptr", Query, "Cdecl Int")
      If (ErrorLevel) {
      ...
      Names := []
      Loop, %RC% {
         StrPtr := DllCall(this._SQLiteDLLRel "\sqlite3_column_name", "Ptr", Query, "Int", A_Index - 1, "Cdecl UPtr")
         If (ErrorLevel) {
      ...
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_step", "Ptr", Query, "Cdecl Int")
      If (ErrorLevel) {
         This.ErrorMsg := "DLLCall sqlite3_step failed!"
         This.ErrorCode := ErrorLevel
         Return False
      ...
      If (RC = This._ReturnCode("SQLITE_ROW"))
         HasRows := True
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_reset", "Ptr", Query, "Cdecl Int")
      If (ErrorLevel) {
         This.ErrorMsg := "DLLCall sqlite3_reset failed!"
         This.ErrorCode := ErrorLevel
         Return False
   ...
   LastInsertRowID(ByRef RowID) {
      ...
      RowID := 0
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_last_insert_rowid", "Ptr", This._Handle, "Cdecl Int64")
      If (ErrorLevel) {
   ...
   TotalChanges(ByRef Rows) {
      ...
      Rows := 0
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_total_changes", "Ptr", This._Handle, "Cdecl Int")
      If (ErrorLevel) {
   ...
   SetTimeout(Timeout := 1000) {
      ...
      If Timeout Is Not Integer
         Timeout := 1000
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_busy_timeout", "Ptr", This._Handle, "Cdecl Int")
      If (ErrorLevel) {
   ...
   EscapeStr(ByRef Str, Quote := True) {
      ...
      Ptr := DllCall(this._SQLiteDLLRel "\sqlite3_mprintf", "Ptr", &OP, "Ptr", &UTF8, "Cdecl UPtr")
      If (ErrorLevel) {
      ...
      DllCall(this._SQLiteDLLRel "\sqlite3_free", "Ptr", Ptr, "Cdecl")
      Return True
   }
   ; ===================================================================================================================
   ...
   StoreBLOB(SQL, BlobArray) {
      ...
      For BlobNum, Blob In BlobArray {
         ...
         RC := DllCall(this._SQLiteDLLRel "\sqlite3_bind_blob", "Ptr", Query, "Int", BlobNum, "Ptr", Blob.Addr
      ...
      RC := DllCall(this._SQLiteDLLRel "\sqlite3_finalize", "Ptr", Query, "Cdecl Int")
      If (ErrorLevel) {
